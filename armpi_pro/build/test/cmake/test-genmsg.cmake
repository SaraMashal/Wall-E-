...
message(STATUS "test: 0 messages, 2 services")
...
get_filename_component(_filename "/home/ubuntu/armpi_pro/src/test/srv/Person.srv" NAME_WE)
add_custom_target(_test_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test" "/home/ubuntu/armpi_pro/src/test/srv/Person.srv" ""
)

get_filename_component(_filename "/home/ubuntu/armpi_pro/src/test/srv/angle.srv" NAME_WE)
add_custom_target(_test_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "test" "/home/ubuntu/armpi_pro/src/test/srv/angle.srv" ""
)
