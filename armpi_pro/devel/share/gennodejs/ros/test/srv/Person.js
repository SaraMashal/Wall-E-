...
class PersonRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int8(obj.sex, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.sex = _deserializer.int8(buffer, bufferOffset);
    return data;
  }
...
module.exports = {
  ...
  md5sum() { return '8252a159fd1a6ef4321e6f234278121d'; },
  datatype() { return 'test/Person'; }
};
